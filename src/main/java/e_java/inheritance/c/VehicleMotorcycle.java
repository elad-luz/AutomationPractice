...
/** Notes
	...
	*/
	...
	public VehicleMotorcycle(int year, double price, String color, boolean hasSideCar) {
	...
	public String toString() {
		return "VehicleMotorcycle [hasSideCar=" + hasSideCar + "]" + super.toString();
	}
	...
	public void printInfo() {
		...
		// System.out.println("VehicleMotorcycle [hasSideCar=" + hasSideCar + "]");
