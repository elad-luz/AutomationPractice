...
public class AnimalCat extends Animal { // StreetCat extends Cat but cat is not abstract !
	...
	public AnimalCat(String c, double w , String n, double a) { // to all attributes
	...
	// constructor for setting partial input	
	public AnimalCat(String c, double w, String n) { // construct to only n c w
		super(c, w); // inherits from parent class: Animal, and initiated here
		this.name = n;
	}
	...
	public void printAge() {
		System.out.println("my cat age is: " + age);
	};
	...
	public void printInfo() { // a method that prints all values of an instance-object with the inherit methods from parent class: Animal
		System.out.println("Cat instance = cat name: " + getName() + " | color: " + getColor() +  " | weight: " + getWeight() + " | age: " + getAge() + " years old | tail: " + AnimalCat.hasTail + "\n");
	}
